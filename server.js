function Main() {
    ...
    this.txtDescr = function() { return 'This is universal application and has a modular structure. In fact it provides API and login for create your own set of applications and separate them into a logical parts.'; };
